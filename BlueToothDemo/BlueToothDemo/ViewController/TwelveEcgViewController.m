...
@interface TwelveEcgViewController ()
{
    DfthTwelveEcgDevice *_ecgDevice;
...
@implementation TwelveEcgViewController
...
- (void)scanECGDevices
{
    if (_getDeviceTask == nil) {
        _getDeviceTask = [DfthSDKManager getTwelveEcgDevice:nil completeHandler:^(DfthResult * _Nonnull result, DfthTwelveEcgDevice * _Nullable device) {
